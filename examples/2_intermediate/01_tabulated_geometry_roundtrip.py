...
"""
01_tabulated_geometry_roundtrip.py
...
Outputs
-------
Written to `out/2_intermediate/tabulated_geometry_roundtrip/`.
"""
...
def main() -> None:
    out_dir = Path("out/2_intermediate/tabulated_geometry_roundtrip")
