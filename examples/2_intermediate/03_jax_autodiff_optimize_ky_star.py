...
"""
03_jax_autodiff_optimize_ky_star.py
...
Outputs
-------
Written to `out/2_intermediate/jax_autodiff_optimize_ky_star/`.
"""
...
def main() -> None:
    out_dir = Path("out/2_intermediate/jax_autodiff_optimize_ky_star")
