"""
mosetto2012_driftwave_branches.py
...
Outputs
-------
Written to `out/examples/06_literature_tokamak_sol/mosetto2012_driftwave_branches/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/06_literature_tokamak_sol/mosetto2012_driftwave_branches")
