...
Run
---
  python examples/3_advanced/08_essos_vmec_edge_s09.py

Outputs
-------
Written to `out/3_advanced/essos_vmec_edge_s09/`.
"""
...
def main() -> None:
    out_dir = Path("out/3_advanced/essos_vmec_edge_s09")
