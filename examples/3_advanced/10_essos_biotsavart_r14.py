...
Run
---
  python examples/3_advanced/10_essos_biotsavart_r14.py

Outputs
-------
Written to `out/3_advanced/essos_biotsavart_r14/`.
"""
...
def main() -> None:
    out_dir = Path("out/3_advanced/essos_biotsavart_r14")
