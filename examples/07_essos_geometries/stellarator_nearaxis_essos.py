...
Outputs
-------
Written to `out/examples/07_essos_geometries/stellarator_nearaxis_essos/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/07_essos_geometries/stellarator_nearaxis_essos")
