...
Outputs
-------
Written to `out/examples/03_sheath_mpse/open_slab_sheath_ky_scan/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/03_sheath_mpse/open_slab_sheath_ky_scan")
