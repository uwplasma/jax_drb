...
Run
---
  python examples/scripts/07_essos_geometries/essos_nearaxis_r01.py

Outputs
-------
Written to `out/examples/07_essos_geometries/essos_nearaxis_r01/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/07_essos_geometries/essos_nearaxis_r01")
