"""
halpern2013_salpha_ideal_ballooning_map.py
...
Outputs
-------
Written to `out/examples/06_literature_tokamak_sol/halpern2013_salpha_ideal_ballooning_map/`:
...
def main() -> None:
    out_dir = Path("out/examples/06_literature_tokamak_sol/halpern2013_salpha_ideal_ballooning_map")
