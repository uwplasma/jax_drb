"""
halpern2013_gradient_removal_lp.py
...
Outputs
-------
Written to `out/examples/06_literature_tokamak_sol/halpern2013_gradient_removal/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/06_literature_tokamak_sol/halpern2013_gradient_removal")
