"""
jorge2016_isttok_linear_workflow.py
...
Outputs
-------
Written to `out/examples/06_literature_tokamak_sol/jorge2016_isttok_linear_workflow/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/06_literature_tokamak_sol/jorge2016_isttok_linear_workflow")
