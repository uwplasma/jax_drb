"""
mosetto2012_ballooning_branches.py
...
Outputs
-------
Written to `out/examples/06_literature_tokamak_sol/mosetto2012_ballooning_branches/`.
"""
...
def main() -> None:
    out_dir = Path("out/examples/06_literature_tokamak_sol/mosetto2012_ballooning_branches")
